...
<body>
	...
	<form name="empform" method="post" id="empform" action="${ctx}/employeelist.action">
		<input type="hidden" name="pageIndex" value="${pb.pageNow}"
			id="pageIndex" />
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}" name = "empIds"></td>
					 <td>${employee.name }</td>
					  ...
					  <td align="center" width="40px;"><a href="${ctx}/toupdateEmployee?flag=1&updateid=${employee.id}">
